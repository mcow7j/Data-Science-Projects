...
features = pd.read_csv("/content/drive/My Drive/Cingulit/data/features.csv")
prices = pd.read_csv("/content/drive/My Drive/Cingulit/data/prices.csv",index_col='date')
sp = pd.read_csv("/content/drive/My Drive/Cingulit/data/sp.csv")
